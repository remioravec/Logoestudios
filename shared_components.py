...
def get_booking_modal():
    ...
    return (
        ...
        '                <form action="https://formsubmit.co/contact@logopsistudios.com" method="POST" class="space-y-3">\n'
        '                    <input type="hidden" name="_subject" value="Demande de bilan — Logo Études">\n'
